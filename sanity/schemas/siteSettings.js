...
const siteSettings = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'string',
      description: 'Root default for every LLM task that has no more specific setting. e.g., openai/gpt-6-luna'
    },
    {
    ...
    },
    {
      ...
      type: 'string',
      description: 'Overrides LLM Model (summaries) for trial work. Leave blank to inherit it. e.g., openai/gpt-6-luna'
    },
    {
