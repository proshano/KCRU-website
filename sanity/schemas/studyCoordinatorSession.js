const studyCoordinatorSession = {
  name: 'studyCoordinatorSession',
  title: 'Study Coordinator Sessions',
  type: 'document',
  fields: [
    {
      name: 'email',
  ...
  preview: {
    ...
    prepare({ email, expiresAt, revoked }) {
      ...
      return {
        title: email || 'Unknown coordinator',
...
export default studyCoordinatorSession
