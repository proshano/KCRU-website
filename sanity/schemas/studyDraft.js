    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'principalInvestigatorName', title: 'Principal Investigator (Other)', type: 'string' },
        {
          ...
          type: 'object',
          fields: [
            { name: 'screeningSummary', title: 'Public Matching Summary', type: 'text', rows: 3 },
            { name: 'sexAllowed', title: 'Sex Requirement', type: 'string' },
            { name: 'minimumAgeYears', title: 'Minimum Age (Years)', type: 'number' },
            { name: 'maximumAgeYears', title: 'Maximum Age (Years)', type: 'number' },
            { name: 'populationTags', title: 'Target Populations', type: 'array', of: [{ type: 'string' }] },
            { name: 'ckdStages', title: 'CKD Stages', type: 'array', of: [{ type: 'string' }] },
            { name: 'dialysisStatus', title: 'Dialysis Requirement', type: 'string' },
            { name: 'transplantStatus', title: 'Transplant Requirement', type: 'string' },
            { name: 'diabetesRequirement', title: 'Diabetes Requirement', type: 'string' },
            { name: 'egfrMin', title: 'Minimum eGFR', type: 'number' },
            { name: 'egfrMax', title: 'Maximum eGFR', type: 'number' },
            { name: 'requiresAlbuminuria', title: 'Requires Albuminuria', type: 'boolean' },
            { name: 'requiresProteinuria', title: 'Requires Proteinuria', type: 'boolean' },
            { name: 'exclusionTags', title: 'Major Exclusion Flags', type: 'array', of: [{ type: 'string' }] },
            { name: 'mustAsk', title: 'Must-Ask Questions', type: 'array', of: [{ type: 'string' }] },
            { name: 'optionalQuestions', title: 'Optional Follow-Up Questions', type: 'array', of: [{ type: 'string' }] },
          ]
        },
        {
          name: 'ctGovData',
