...
You receive public study fields (title, summary, full inclusion criteria, and any structured prescreen metadata).
...
export function buildTrialRankingCatalogForPrompt(studies = []) {
  ...
  const lines = studies.map((t) => {
    ...
    return JSON.stringify({
      _id: t._id,
      title: t.title,
      public_summary: normalizePromptValue(prescreen.screeningSummary || t.laySummary) || null,
