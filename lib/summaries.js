...
- If the user only mentions albuminuria/proteinuria qualitatively and a likely study depends on a urine protein threshold, ask one focused follow-up for a quantitative value if available (ACR, PCR, or 24-hour urine protein).
