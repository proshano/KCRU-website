...
export const queries = {
  ...
  researchDigestIssues: `
    *[_type == "researchDigestIssue" && status in ["approved", "sent"]] | order(date desc)[0...20] {
      ...
      approvedAt,
      sentAt,
      "paperCount": count(*[_type == "researchDigestPaper" && issueDate == ^.date && approvalStatus == "approved"])
    }
  `,
  ...
  researchDigestIssueBySlug: `
    *[_type == "researchDigestIssue" && slug.current == $slug && status in ["approved", "sent"]][0] {
      ...
      approvedAt,
      sentAt,
      "papers": *[_type == "researchDigestPaper" && issueDate == ^.date && approvalStatus == "approved"] | order(tier asc, journal asc, title asc) {
        _id,
        pmid,
        doi,
        title,
