...
async function sendWithResend({ apiKey, from, to, subject, text, html, replyTo, attachments, idempotencyKey }) {
...
export async function sendEmail({ to, subject, text, html, replyTo, attachments, idempotencyKey }) {
