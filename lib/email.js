...
async function sendWithResend({ apiKey, from, to, subject, text, html, replyTo, attachments, tags }) {
...
export async function sendEmail({ to, subject, text, html, replyTo, attachments, tags }) {
  ...
  if (resendKey) {
    ...
    return sendWithResend({ apiKey: resendKey, from, to, subject, text, html, replyTo, attachments, tags })
  }
