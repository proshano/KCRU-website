...
async function sendWithSendGrid({ apiKey, from, to, subject, text, html, replyTo, attachments }) {
...
export async function sendEmail({ to, subject, text, html, replyTo, attachments }) {
  ...
  return sendWithSendGrid({ apiKey: sendgridKey, from, to, subject, text, html, replyTo, attachments })
}
