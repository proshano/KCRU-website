...
function buildStudyHtmlBlock(study, senderEmail, siteBaseUrl) {
  ...
  const detailsHtml = studyUrl
    ? `<a href="${escapeHtml(studyUrl)}" style="display: inline-block; padding: 10px 14px; border: 1px solid ${BORDER_COLOR}; color: #111; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 13px; margin-left: 8px;">
        Read more
      </a>`
    : ''
