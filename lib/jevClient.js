...
// OpenRouter is the default because it is the provider the rest of the site already runs on
// and needs no new credential. A TypeSafe key, when one exists, switches to the direct API.
