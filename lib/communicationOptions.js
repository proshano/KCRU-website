...
export const CORRESPONDENCE_OPTIONS = [
  { title: 'Regular updates with studies available to patients in your care setting', value: 'study_updates' },
  { title: 'Occasional news about our research programs', value: 'newsletter' }
]
...
export const THERAPEUTIC_AREA_LABELS = new Map(
  THERAPEUTIC_AREA_OPTIONS.map((area) => [area.value, area.title])
)

export function getTherapeuticAreaLabel(value) {
  if (!value) return ''
  return THERAPEUTIC_AREA_LABELS.get(value) || value
}
