...
export async function generateMissingSummaries({
  ...
  if (needsSummary.length === 0) {
    const reason = withoutSummary.length > 0 ? 'remaining publications lack abstracts' : 'all have summaries'
    console.info('[pubmed] All eligible publications already have summaries', { reason })
    return {
      attempted: 0,
      generated: 0,
