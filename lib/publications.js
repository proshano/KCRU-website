...
export async function generateMissingSummaries({
  ...
  if (needsSummary.length === 0 && needsClassification.length === 0 && classificationUpdates.length === 0) {
