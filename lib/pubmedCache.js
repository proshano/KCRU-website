...
import { getPublicationKey, toSanityPublicationKey, withPublicationKey } from './publicationIdentity.js'
...
function toSanityPublication(pub, idx = 0) {
  ...
  return {
    ...
    attributionQueryPaths: Array.from(new Set(normalized.attributionQueryPaths || [])),
