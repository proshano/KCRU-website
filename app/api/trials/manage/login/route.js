...
export async function POST(request) {
  ...
  try {
    ...
    const subject = 'Study manager: your passcode'
    const text = [
      'Use this passcode to access the study manager:',
      code,
      '',
    ...
    const html = `
      <div style="font-family: system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif; font-size: 14px; color: #111; line-height: 1.5;">
        <p style="margin: 0 0 12px;"><strong>Study manager sign-in</strong></p>
        <p style="margin: 0 0 12px;">Use this passcode to access the study manager:</p>
